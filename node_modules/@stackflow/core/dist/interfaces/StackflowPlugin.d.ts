...
import type { StackflowPluginHook, StackflowPluginPostEffectHook, StackflowPluginPreEffectHook } from "./StackflowPluginHook";
export type StackflowPlugin = () => {
     ...
     */
    onBeforeStepPush?: StackflowPluginPreEffectHook<Omit<StepPushedEvent, keyof BaseDomainEvent>>;
    /**
     * Called before the `stepReplace()` function of `useStepAction()` is called and the corresponding signal is delivered to the core
     */
    onBeforeStepReplace?: StackflowPluginPreEffectHook<Omit<StepReplacedEvent, keyof BaseDomainEvent>>;
    /**
     * Called before the `stepPop()` function of `useStepActions()` is called and the corresponding signal is delivered to the core
     */
    onBeforeStepPop?: StackflowPluginPreEffectHook<Omit<StepPoppedEvent, keyof BaseDomainEvent>>;
    /**
...
//# sourceMappingURL=StackflowPlugin.d.ts.map